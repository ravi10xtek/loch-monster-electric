export const servicePages = {
  ...
  hoa: {
    ...
    whatWeHandle: {
      ...
      cards: {
        common: [
          { label: 'HALLWAY & LOBBY LIGHTING', body: 'Interior common area lighting kept bright, efficient, and compliant for residents and guests.', href: '/hoa-electrical-services/hoa-common-areas/hallway-lobby-lighting', color: '#2a2a2a', gradient: 'linear-gradient(160deg,#191919,#333)' },
          { label: 'EXTERIOR & PARKING LIGHTING', body: 'Parking lot, walkway, and entry lighting installed and maintained for safety and security.', href: '/hoa-electrical-services/hoa-common-areas/exterior-parking-lighting', color: '#1a2a1a', gradient: 'linear-gradient(160deg,#0d1f0d,#2a3a2a)' },
          { label: 'AMENITY ELECTRICAL', body: 'Pool, clubhouse, fitness center, and shared space electrical kept safe and operational.', href: '/hoa-electrical-services/hoa-common-areas/amenity-electrical', color: '#1a1a2a', gradient: 'linear-gradient(160deg,#0d0d1f,#2a2a3a)' },
        ],
        emergency: [
          { label: '24/7 EMERGENCY RESPONSE', body: 'Around-the-clock emergency electrical service for HOAs and property managers who can\'t wait.', href: '/hoa-electrical-services/hoa-emergency-repairs/247-emergency-response', color: '#2a2a2a', gradient: 'linear-gradient(160deg,#191919,#333)' },
          { label: 'POWER RESTORATION', body: 'Rapid diagnosis and restoration of power outages affecting units or common areas.', href: '/hoa-electrical-services/hoa-emergency-repairs/power-restoration', color: '#1a2a1a', gradient: 'linear-gradient(160deg,#0d1f0d,#2a3a2a)' },
          { label: 'STORM DAMAGE REPAIR', body: 'Post-storm electrical assessment and repair to get your property back online fast.', href: '/hoa-electrical-services/hoa-emergency-repairs/storm-damage-repair', color: '#1a1a2a', gradient: 'linear-gradient(160deg,#0d0d1f,#2a2a3a)' },
        ],
        ev: [
          { label: 'EV STATION INSTALLATION', body: 'Level 2 EV charger installation in parking areas—single units or multi-port stations.', href: '/hoa-electrical-services/hoa-ev-charging/ev-station-installation', color: '#2a2a2a', gradient: 'linear-gradient(160deg,#191919,#333)' },
          { label: 'LOAD MANAGEMENT', body: 'Smart load management systems that balance EV charging demand with your building\'s capacity.', href: '/hoa-electrical-services/hoa-ev-charging/load-management', color: '#1a2a1a', gradient: 'linear-gradient(160deg,#0d1f0d,#2a3a2a)' },
          { label: 'PERMIT & INSPECTION', body: 'Full permit pulling and city inspection coordination so you don\'t have to deal with the paperwork.', href: '/hoa-electrical-services/hoa-ev-charging/permit-inspection', color: '#1a1a2a', gradient: 'linear-gradient(160deg,#0d0d1f,#2a2a3a)' },
        ],
        inspections: [
          { label: 'ANNUAL INSPECTIONS', body: 'Scheduled annual electrical inspections for common areas, panels, and shared systems.', href: '/hoa-electrical-services/hoa-inspections/annual-inspections', color: '#2a2a2a', gradient: 'linear-gradient(160deg,#191919,#333)' },
          { label: 'CODE COMPLIANCE CHECKS', body: 'Keep your property current with NEC code requirements and avoid liability exposure.', href: '/hoa-electrical-services/hoa-inspections/code-compliance-checks', color: '#1a2a1a', gradient: 'linear-gradient(160deg,#0d1f0d,#2a3a2a)' },
          { label: 'MAINTENANCE CONTRACTS', body: 'Ongoing maintenance agreements for predictable budgeting and priority scheduling.', href: '/hoa-electrical-services/hoa-inspections/hoa-maintenance-contracts', color: '#1a1a2a', gradient: 'linear-gradient(160deg,#0d0d1f,#2a2a3a)' },
        ],
      },
      ctaCard: 'ALL HOA\nSERVICES',
    },
